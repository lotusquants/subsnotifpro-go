...
type SubscriptionCatalogRepository interface {
	...
	UpsertSubscriptionBasePlans(ctx context.Context, basePlan *models.ProductBasePlan) error // ✅ Base Plan Upsert
	// ✅ Subscription Offers Functions
	UpsertSubscriptionOffers(ctx context.Context, offers []models.SubscriptionOffer) error

	DeleteAllSubscriptionOffers(ctx context.Context, packageName string, productID string, basePlanID string) error
}
