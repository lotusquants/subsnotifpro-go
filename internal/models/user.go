...
import (
	"subsnotifpro-go/internal/google_playstore/rtdn/models" // Import Google Play models
	"time"
)
...
type AppUserPlatformChange struct {
	...
	Reason      string    `gorm:"type:varchar(255);null"`    // Optional reason for platform change (if needed)
}
